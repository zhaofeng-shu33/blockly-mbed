...
/**
 * @fileoverview Blocks for mbed Stepper library.
 *     The mbed Servo functions syntax can be found in the following URL:
 *     http://mbed.cc/en/Reference/Stepper
...
Blockly.Blocks['stepper_config'] = {
   ...
   */
  init: function() {
    this.setHelpUrl('http://mbed.cc/en/Reference/StepperConstructor');
    ...
    this.appendDummyInput()
        ...
        .appendField(new Blockly.FieldDropdown(
            Blockly.mbed.Boards.selected.digitalPins), 'STEPPER_PIN1')
        .appendField(Blockly.Msg.ARD_STEPPER_PIN2)
        .appendField(new Blockly.FieldDropdown(
            Blockly.mbed.Boards.selected.digitalPins), 'STEPPER_PIN2');
...
Blockly.Blocks['stepper_step'] = {
   ...
   */
  init: function() {
    this.setHelpUrl('http://mbed.cc/en/Reference/StepperStep');
    this.setColour(Blockly.Blocks.stepper.HUE);
    this.appendDummyInput()
