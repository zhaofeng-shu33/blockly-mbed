...
/** @export */ Blockly.Msg.MBED_ANALOGREAD = "read analog pin#";
/** @export */ Blockly.Msg.MBED_ANALOGREAD_TIP = "Return value between 0 and 1024";
/** @export */ Blockly.Msg.MBED_ANALOGWRITE = "set analog pin#";
/** @export */ Blockly.Msg.MBED_ANALOGWRITE_TIP = "Write analog value between 0 and 255 to a specific PWM Port";
/** @export */ Blockly.Msg.MBED_BUILTIN_LED = "set built-in LED";
/** @export */ Blockly.Msg.MBED_BUILTIN_LED_TIP = "Light on or off for the built-in LED of the Arduino";
/** @export */ Blockly.Msg.MBED_COMPONENT_WARN1 = "A %1 configuration block with the same %2 name must be added to use this block!";
/** @export */ Blockly.Msg.MBED_DEFINE = "Define";
/** @export */ Blockly.Msg.MBED_DIGITALREAD = "read digital pin#";
/** @export */ Blockly.Msg.MBED_DIGITALREAD_TIP = "Read digital value on a pin: HIGH or LOW";
/** @export */ Blockly.Msg.MBED_DIGITALWRITE = "set digitial pin#";
/** @export */ Blockly.Msg.MBED_DIGITALWRITE_TIP = "Write digital value HIGH or LOW to a specific Port";
/** @export */ Blockly.Msg.MBED_FUN_RUN_LOOP = "Arduino loop forever:";
/** @export */ Blockly.Msg.MBED_FUN_RUN_SETUP = "Arduino run first:";
/** @export */ Blockly.Msg.MBED_FUN_RUN_TIP = "Defines the Arduino setup() and loop() functions.";
/** @export */ Blockly.Msg.MBED_HIGH = "HIGH";
/** @export */ Blockly.Msg.MBED_HIGHLOW_TIP = "Set a pin state logic High or Low.";
/** @export */ Blockly.Msg.MBED_LOW = "LOW";
/** @export */ Blockly.Msg.MBED_MACRO_DEFAULT_NAME = "newMacro";
/** @export */ Blockly.Msg.MBED_MACRO_DEFINE = "define %1 as %2";
/** @export */ Blockly.Msg.MBED_MACRO_DEFINE_CREATE_SET = "Create 'define %1'";
/** @export */ Blockly.Msg.MBED_MACRO_DEFINE_HELPURL = "";
/** @export */ Blockly.Msg.MBED_MACRO_DEFINE_TOOLTIP = "Defines this macro to be equal to the input.";
/** @export */ Blockly.Msg.MBED_MACRO_GET_HELPURL = "";
/** @export */ Blockly.Msg.MBED_MACRO_GET_TOOLTIP = "get the value of this macro";
/** @export */ Blockly.Msg.MBED_MAP = "Map";
/** @export */ Blockly.Msg.MBED_MAP_TIP = "Re-maps a number from [0-1024] to another.";
/** @export */ Blockly.Msg.MBED_MAP_VAL = "value to [0-";
/** @export */ Blockly.Msg.MBED_NEW_MACRO = "New macro...";
/** @export */ Blockly.Msg.MBED_NEW_MACRO_TITLE = "New macro name:";
/** @export */ Blockly.Msg.MBED_NOTONE = "Turn off tone on pin #";
/** @export */ Blockly.Msg.MBED_NOTONE_PIN = "No tone PIN#";
/** @export */ Blockly.Msg.MBED_NOTONE_PIN_TIP = "Stop generating a tone on a pin";
/** @export */ Blockly.Msg.MBED_NOTONE_TIP = "Turns the tone off on the selected pin";
/** @export */ Blockly.Msg.MBED_PIN_WARN1 = "Pin %1 is needed for %2 as pin %3. Already used as %4.";
/** @export */ Blockly.Msg.MBED_PULSEON = "pulse on pin #";
/** @export */ Blockly.Msg.MBED_PULSEREAD = "Read";
/** @export */ Blockly.Msg.MBED_PULSETIMEOUT = "timeout after";
/** @export */ Blockly.Msg.MBED_PULSETIMEOUT_MS = "";
/** @export */ Blockly.Msg.MBED_PULSETIMEOUT_TIP = "Measures the duration of a pulse on the selected pin, if it is within the timeout.";
/** @export */ Blockly.Msg.MBED_PULSE_TIP = "Measures the duration of a pulse on the selected pin.";
/** @export */ Blockly.Msg.MBED_RENAME_MACRO = "Rename macro...";
/** @export */ Blockly.Msg.MBED_RENAME_MACRO_TITLE = "Rename all '%1' macros to:";
/** @export */ Blockly.Msg.MBED_SERIAL_BPS = "bps";
/** @export */ Blockly.Msg.MBED_SERIAL_PRINT = "print";
/** @export */ Blockly.Msg.MBED_SERIAL_PRINT_NEWLINE = "add new line";
/** @export */ Blockly.Msg.MBED_SERIAL_PRINT_TIP = "Prints data to the console/serial port as human-readable ASCII text.";
/** @export */ Blockly.Msg.MBED_SERIAL_PRINT_WARN = "A setup block for %1 must be added to the workspace to use this block!";
/** @export */ Blockly.Msg.MBED_SERIAL_SETUP = "Setup";
/** @export */ Blockly.Msg.MBED_SERIAL_SETUP_TIP = "Selects the speed for a specific Serial peripheral";
/** @export */ Blockly.Msg.MBED_SERIAL_SPEED = ":  speed to";
/** @export */ Blockly.Msg.MBED_SERVO_READ = "read SERVO from PIN#";
/** @export */ Blockly.Msg.MBED_SERVO_READ_TIP = "Read a Servo angle";
/** @export */ Blockly.Msg.MBED_SERVO_WRITE = "set SERVO from Pin";
/** @export */ Blockly.Msg.MBED_SERVO_WRITE_DEG_180 = "Degrees (0~180)";
/** @export */ Blockly.Msg.MBED_SERVO_WRITE_TIP = "Set a Servo to an specified angle";
/** @export */ Blockly.Msg.MBED_SERVO_WRITE_TO = "to";
/** @export */ Blockly.Msg.MBED_SETTONE = "Set tone on pin #";
/** @export */ Blockly.Msg.MBED_SPI_SETUP = "Setup";
/** @export */ Blockly.Msg.MBED_SPI_SETUP_CONF = "configuration:";
/** @export */ Blockly.Msg.MBED_SPI_SETUP_DIVIDE = "clock divide";
/** @export */ Blockly.Msg.MBED_SPI_SETUP_LSBFIRST = "LSBFIRST";
/** @export */ Blockly.Msg.MBED_SPI_SETUP_MODE = "SPI mode (idle - edge)";
/** @export */ Blockly.Msg.MBED_SPI_SETUP_MODE0 = "0 (Low - Falling)";
/** @export */ Blockly.Msg.MBED_SPI_SETUP_MODE1 = "1 (Low - Rising)";
/** @export */ Blockly.Msg.MBED_SPI_SETUP_MODE2 = "2 (High - Falling)";
/** @export */ Blockly.Msg.MBED_SPI_SETUP_MODE3 = "3 (High - Rising)";
/** @export */ Blockly.Msg.MBED_SPI_SETUP_MSBFIRST = "MSBFIRST";
/** @export */ Blockly.Msg.MBED_SPI_SETUP_SHIFT = "data shift";
/** @export */ Blockly.Msg.MBED_SPI_SETUP_TIP = "Configures the SPI peripheral.";
/** @export */ Blockly.Msg.MBED_SPI_TRANSRETURN_TIP = "Send a SPI message to an specified slave device and get data back.";
/** @export */ Blockly.Msg.MBED_SPI_TRANS_NONE = "none";
/** @export */ Blockly.Msg.MBED_SPI_TRANS_SLAVE = "to slave pin";
/** @export */ Blockly.Msg.MBED_SPI_TRANS_TIP = "Send a SPI message to an specified slave device.";
/** @export */ Blockly.Msg.MBED_SPI_TRANS_VAL = "transfer";
/** @export */ Blockly.Msg.MBED_SPI_TRANS_WARN1 = "A setup block for %1 must be added to the workspace to use this block!";
/** @export */ Blockly.Msg.MBED_SPI_TRANS_WARN2 = "Old pin value %1 is no longer available.";
/** @export */ Blockly.Msg.MBED_STEPPER_COMPONENT = "stepper";
/** @export */ Blockly.Msg.MBED_STEPPER_DEFAULT_NAME = "MyStepper";
/** @export */ Blockly.Msg.MBED_STEPPER_MOTOR = "stepper motor:";
/** @export */ Blockly.Msg.MBED_STEPPER_PIN1 = "pin1#";
/** @export */ Blockly.Msg.MBED_STEPPER_PIN2 = "pin2#";
/** @export */ Blockly.Msg.MBED_STEPPER_REVOLVS = "how many steps per revolution";
/** @export */ Blockly.Msg.MBED_STEPPER_SETUP = "Setup stepper motor";
/** @export */ Blockly.Msg.MBED_STEPPER_SETUP_TIP = "Configures a stepper motor pinout and other settings.";
/** @export */ Blockly.Msg.MBED_STEPPER_SPEED = "set speed (rpm) to";
/** @export */ Blockly.Msg.MBED_STEPPER_STEP = "move stepper";
/** @export */ Blockly.Msg.MBED_STEPPER_STEPS = "steps";
/** @export */ Blockly.Msg.MBED_STEPPER_STEP_TIP = "Turns the stepper motor a specific number of steps.";
/** @export */ Blockly.Msg.MBED_TIME_DELAY = "wait";
/** @export */ Blockly.Msg.MBED_TIME_DELAY_MICROS = "microseconds";
/** @export */ Blockly.Msg.MBED_TIME_DELAY_MICRO_TIP = "Wait specific time in microseconds";
/** @export */ Blockly.Msg.MBED_TIME_DELAY_TIP = "Wait specific time in milliseconds";
/** @export */ Blockly.Msg.MBED_TIME_INF = "wait forever (end program)";
/** @export */ Blockly.Msg.MBED_TIME_INF_TIP = "Wait indefinitely, stopping the program.";
/** @export */ Blockly.Msg.MBED_TIME_MICROS = "current elapsed Time (microseconds)";
/** @export */ Blockly.Msg.MBED_TIME_MICROS_TIP = "Returns the number of microseconds since the Arduino board began running the current program. Has to be stored in a positive long integer";
/** @export */ Blockly.Msg.MBED_TIME_MILLIS = "current elapsed Time (milliseconds)";
/** @export */ Blockly.Msg.MBED_TIME_MILLIS_TIP = "Returns the number of milliseconds since the Arduino board began running the current program. Has to be stored in a positive long integer";
/** @export */ Blockly.Msg.MBED_TIME_MS = "milliseconds";
/** @export */ Blockly.Msg.MBED_TONEFREQ = "at frequency";
/** @export */ Blockly.Msg.MBED_TONE_FREQ = "frequency";
/** @export */ Blockly.Msg.MBED_TONE_PIN = "Tone PIN#";
/** @export */ Blockly.Msg.MBED_TONE_PIN_TIP = "Generate audio tones on a pin";
/** @export */ Blockly.Msg.MBED_TONE_TIP = "Sets tone on pin to specified frequency within range 31 - 65535";
/** @export */ Blockly.Msg.MBED_TONE_WARNING = "Frequency must be in range 31 - 65535";
/** @export */ Blockly.Msg.MBED_TYPE_ARRAY = "Array";
/** @export */ Blockly.Msg.MBED_TYPE_BOOL = "Boolean";
/** @export */ Blockly.Msg.MBED_TYPE_CHAR = "Character";
/** @export */ Blockly.Msg.MBED_TYPE_CHILDBLOCKMISSING = "ChildBlockMissing";
/** @export */ Blockly.Msg.MBED_TYPE_DECIMAL = "Decimal";
/** @export */ Blockly.Msg.MBED_TYPE_LONG = "Large Number";
/** @export */ Blockly.Msg.MBED_TYPE_NULL = "Null";
/** @export */ Blockly.Msg.MBED_TYPE_NUMBER = "Number";
/** @export */ Blockly.Msg.MBED_TYPE_SHORT = "Short Number";
/** @export */ Blockly.Msg.MBED_TYPE_TEXT = "Text";
/** @export */ Blockly.Msg.MBED_TYPE_UNDEF = "Undefined";
/** @export */ Blockly.Msg.MBED_VALUE = "value";
/** @export */ Blockly.Msg.MBED_VAR_AS = "as";
/** @export */ Blockly.Msg.MBED_VAR_AS_TIP = "Sets a value to a specific type";
/** @export */ Blockly.Msg.MBED_WRITE_TO = "to";
