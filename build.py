# This file is used to collect block core library (js files) and its depedencies, 
# we generate blockly_compressed.js
...
class Gen_compressed(threading.Thread):
  ...
  def gen_core(self):
    ...
    #we save the file name to json file format
    import json
    with open('core_build_list.json','w') as f:
...
developers.google.com/blockly/guides/modify/web/closure""")
    sys.exit(1)
  core_search_paths = list(calcdeps.ExpandDirectories(["core", os.path.join(os.path.pardir, "closure-library")]))
  core_search_paths.sort()  # Deterministic build.
  full_search_paths = list(calcdeps.ExpandDirectories(["accessible", "core", os.path.join(os.path.pardir, "closure-library")]))
